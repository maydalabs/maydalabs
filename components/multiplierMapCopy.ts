...
export const MAP_COPY: Record<Locale, MapCopy> = {
  en: {
    ...
    saveHint: "Keep it, revisit it, compare later. Sign-in is a one-time email code — no password.",
    ...
    authIntro: "Enter your email to save this map. We send a one-time code — no password, no spam.",
    emailLabel: "Email",
  ...
  tr: {
    ...
    saveHint: "Saklayın, dönün, sonra karşılaştırın. Giriş tek kullanımlık e-posta kodu ile — parola yok.",
    ...
    authIntro: "Bu haritayı kaydetmek için e-postanızı girin. Tek kullanımlık bir kod göndeririz — parola yok, spam yok.",
    emailLabel: "E-posta",
  ...
  fr: {
    ...
    saveHint: "Gardez-la, revenez-y, comparez plus tard. Connexion par code e-mail à usage unique — sans mot de passe.",
    ...
    authIntro: "Entrez votre e-mail pour enregistrer cette carte. Nous envoyons un code à usage unique — sans mot de passe, sans spam.",
    emailLabel: "E-mail",
