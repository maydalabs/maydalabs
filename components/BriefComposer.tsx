...
const COPY: Record<Locale, {
  ...
  en: {
    ...
    heading: ["Review what you brought.", "Then choose the next step."],
    ...
    ideaLabel: "The idea or problem, in your words",
    ideaPlaceholder: "What do you want to build or fix, who feels it, and what exists today? Rough is fine.",
    stageLabel: "Stage",
    stages: [
      { id: "idea", label: "Idea" },
    ...
    copied: "Copied",
    bookAction: "Open the 30-minute calendar",
    mailAction: "Send it by email instead",
  ...
  tr: {
    ...
    heading: ["Getirdiğinizi inceleyin.", "Sonraki adımı siz seçin."],
    ...
    ideaLabel: "Fikir veya problem, kendi kelimelerinizle",
    ideaPlaceholder: "Neyi geliştirmek veya düzeltmek istiyorsunuz, bunu kim hissediyor ve bugün ne mevcut? Taslak hali yeterli.",
    stageLabel: "Aşama",
    stages: [
      { id: "idea", label: "Fikir" },
    ...
    copied: "Kopyalandı",
    bookAction: "30 dakikalık takvimi aç",
    mailAction: "Bunun yerine e-postayla gönder",
  ...
  fr: {
    ...
    heading: ["Relisez ce que vous avez apporté.", "Puis choisissez la suite."],
    ...
    ideaLabel: "L’idée ou le problème, avec vos mots",
    ideaPlaceholder: "Que souhaitez-vous construire ou corriger, qui est concerné et qu’existe-t-il aujourd’hui ? Une ébauche suffit.",
    stageLabel: "Stade",
    stages: [
      { id: "idea", label: "Idée" },
      { id: "prototype", label: "Prototype" },
    ...
    copied: "Copié",
    bookAction: "Ouvrir l’agenda de 30 minutes",
    mailAction: "L’envoyer plutôt par e-mail",
