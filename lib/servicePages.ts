...
type ServicePage = {
  ...
  proof: string;
  faq: [string, string][];
  /* Only for the two services where MaydaLabs can keep operating the thing it
   * built. Optional on purpose: a service without a truthful running offer
   * must not grow one just because the field exists. */
  runWithYou?: { heading: string; body: string; note: string };
};
...
export const SERVICE_PAGES: Record<Locale, Record<ServiceId, ServicePage>> = {
  en: {
    ...
    automation: {
      ...
      runWithYou: {
        heading: "Or we can keep running it with you.",
        body: "Some workflows are worth operating, not just installing. We can run the workflow every month and hand you the work to approve: you see what was produced, the source behind each claim, and nothing goes out until you say so.",
        note: "Optional, month to month, and scoped and priced before it starts. The workflow is yours either way.",
      },
    },
    email: {
      ...
      runWithYou: {
        heading: "Or we can keep running it with you.",
        body: "Campaigns and follow-ups need someone to write and check them every month. We can prepare each one and hand it to you for approval, so the sending stays yours and the writing stops being your evening job.",
        note: "Optional, month to month, and scoped and priced before it starts. Your list, your accounts, your final say.",
      },
    },
    support: {
  ...
  tr: {
    ...
    automation: {
      ...
      runWithYou: {
        heading: "Ya da işletmeye birlikte devam edebiliriz.",
        body: "Bazı iş akışlarını yalnızca kurmak yetmez, işletmek gerekir. İş akışını her ay biz çalıştırıp işi onayınıza sunabiliriz: ne üretildiğini ve her iddianın kaynağını görürsünüz, siz onaylamadan hiçbir şey dışarı çıkmaz.",
        note: "İsteğe bağlı, aydan aya. Kapsam ve ücret başlamadan önce belirlenir. Her durumda iş akışı sizindir.",
      },
    },
    email: {
      ...
      runWithYou: {
        heading: "Ya da işletmeye birlikte devam edebiliriz.",
        body: "Kampanyaların ve takip mesajlarının her ay yazılması ve kontrol edilmesi gerekir. Her birini biz hazırlayıp onayınıza sunabiliriz; gönderim sizde kalır, yazma işi akşamlarınızı almaz.",
        note: "İsteğe bağlı, aydan aya. Kapsam ve ücret başlamadan önce belirlenir. Listeniz, hesaplarınız ve son söz sizin.",
      },
    },
    support: {
  ...
  fr: {
    ...
    automation: {
      ...
      runWithYou: {
        heading: "Ou nous pouvons continuer à le faire tourner avec vous.",
        body: "Certains processus méritent d’être exploités, pas seulement installés. Nous pouvons exécuter le processus chaque mois et vous remettre le travail à valider : vous voyez ce qui a été produit et la source de chaque affirmation, et rien ne sort avant votre accord.",
        note: "Optionnel, au mois. Périmètre et prix convenus avant de commencer. Le processus vous appartient dans tous les cas.",
      },
    },
    email: {
      ...
      runWithYou: {
        heading: "Ou nous pouvons continuer à le faire tourner avec vous.",
        body: "Les campagnes et les relances demandent que quelqu’un les écrive et les vérifie chaque mois. Nous pouvons préparer chacune et vous la soumettre pour validation : l’envoi reste le vôtre, et la rédaction cesse d’être votre travail du soir.",
        note: "Optionnel, au mois. Périmètre et prix convenus avant de commencer. Votre liste, vos comptes, votre décision finale.",
      },
    },
    support: {
