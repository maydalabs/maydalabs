    ...
    <div className="space-y-10 md:space-y-12">
      ...
      <section className="space-y-3">
        ...
        <p className="max-w-2xl text-sm text-muted sm:text-[0.95rem]">
          ...
          or close rate before you change anything. This page will become the
          full calculator with real inputs, scenarios, and shareable links.
        </p>
      ...
      <section className="grid gap-6 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] md:items-start">
        {/* Inputs + assumptions */}
        <div className="space-y-5 rounded-2xl border border-border bg-surface p-5 sm:p-6">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <div className="space-y-1 rounded-xl border border-border/60 bg-surface-alt/60 p-3">
            ...
            <div className="space-y-1 rounded-xl border border-border/60 bg-surface-alt/60 p-3">
              ...
              <div className="text-sm font-medium text-foreground">42,000</div>
              <div className="text-[0.8rem] text-muted">
      ...
      {/* FAQ / explainer */}
      <section>
        <div className="flex flex-col gap-4 rounded-2xl border border-border bg-surface-alt/70 p-5 sm:flex-row sm:justify-between sm:p-6">
          <div className="space-y-2">
            <h2 className="text-lg font-semibold text-foreground sm:text-xl">
