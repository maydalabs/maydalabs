    ...
    <div className="space-y-10 md:space-y-14">
      ...
      <header className="space-y-3">
        ...
        <p className="max-w-2xl text-sm text-muted sm:text-[0.95rem]">
          ...
          microsites and deeper write-ups will live here as Mayda Labs publishes
          more work.
        </p>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <article className="flex flex-col gap-3 rounded-xl border border-border bg-surface p-5 text-sm">
            ...
            <p className="text-[0.8rem] text-muted">
              ...
              redesign, in-app nudges, lifecycle emails tied to real behaviour.
            </p>
          </article>
          ...
          <article className="flex flex-col gap-3 rounded-xl border border-border bg-surface p-5 text-sm">
            ...
            <p className="text-[0.8rem] text-muted">
              ...
              offer clarity, form and funnel experiments, lifecycle and content
              cadence.
            </p>
          </article>
