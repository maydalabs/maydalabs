...
const COPY = {
  en: {
    meta: { title: "What do you need?", socialTitle: "Shape your project brief · MaydaLabs", description: "Choose the product, growth, commerce, or controlled-automation problem you want MaydaLabs to help move." }, availability: "Open for new client work", kicker: "Start here / Brief before calendar", heading: ["What do you need", "to move?"], intro: "Choose the closest path, describe the situation in your own words, and leave with a structured brief. Nothing is sent until you decide; a call is available only after the problem has a shape.", choose: "Choose a path", email: "Write directly", pathsKicker: "Choose a starting point", pathsHeading: "Which problem is closest to yours?", explore: "Choose this path",
  ...
  tr: {
    meta: { title: "Neye ihtiyacınız var?", socialTitle: "Proje brief'inizi şekillendirin · MaydaLabs", description: "MaydaLabs'in ilerletmesini istediğiniz ürün, büyüme, e-ticaret veya kontrollü otomasyon problemini seçin." }, availability: "Yeni müşteri projelerine açık", kicker: "Buradan başlayın / Takvimden önce brief", heading: ["Neyi ilerletmeye", "ihtiyacınız var?"], intro: "En yakın yolu seçin, durumu kendi kelimelerinizle anlatın ve yapılandırılmış bir brief oluşturun. Siz karar verene kadar hiçbir şey gönderilmez; görüşme ancak problem şekillendikten sonra gelir.", choose: "Bir yol seçin", email: "Doğrudan yazın", pathsKicker: "Bir başlangıç noktası seçin", pathsHeading: "Hangi problem sizinkine en yakın?", explore: "Bu yolu seç",
  ...
  fr: {
    meta: { title: "De quoi avez-vous besoin ?", socialTitle: "Structurez votre brief projet · MaydaLabs", description: "Choisissez le problème produit, croissance, e-commerce ou automatisation contrôlée que MaydaLabs doit faire avancer." }, availability: "Ouvert à de nouveaux projets clients", kicker: "Commencez ici / Le brief avant l’agenda", heading: ["Que devez-vous", "faire avancer ?"], intro: "Choisissez le parcours le plus proche, décrivez la situation avec vos mots et repartez avec un brief structuré. Rien n’est envoyé sans votre décision; l’appel vient seulement lorsque le problème a pris forme.", choose: "Choisir un parcours", email: "Écrire directement", pathsKicker: "Choisissez un point de départ", pathsHeading: "Quel problème ressemble au vôtre ?", explore: "Choisir ce parcours",
  ...
  return (
    <div className="studio-inner-page">
      <section className="studio-inner-hero contact-hero">
        ...
        <div className="flex flex-col gap-3 sm:flex-row"><a href="#needs" className="studio-button">{copy.choose} <span aria-hidden>↓</span></a><a href="mailto:info@maydalabs.com" className="studio-button studio-button-ghost">{copy.email}</a></div>
      </section>
