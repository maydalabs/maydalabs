...
const COPY = {
  ...
  tr: {
    meta: { title: "Proje başlat", socialTitle: "Dağınık fikri getirin · MaydaLabs", description: "Uygulama, pazar yeri, e-ticaret veya büyüme projenizi MaydaLabs ile konuşun." }, availability: "Yeni müşteri projelerine açık", kicker: "Proje başlat / Zorlama satış yok", heading: ["Gerçeğe dönüştürmek", "istediğinizi anlatın."], intro: "Fikri, yarım kalmış ürünü veya henüz kimsenin çözemediği problemi getirin. İlk görüşmede sinyali bulacak ve birlikte geliştirmemiz gerekip gerekmediğine karar vereceğiz.", book: "Proje görüşmesi ayarla", email: "Brief'i e-postayla gönder", pathsKicker: "Bir başlangıç noktası seçin", pathsHeading: "Nasıl bir hamle yapıyoruz?", explore: "Uyumu incele",
  ...
  fr: {
    meta: { title: "Lancer un projet", socialTitle: "Apportez l’idée encore floue · MaydaLabs", description: "Parlez à MaydaLabs de votre application, marketplace, e-commerce ou projet de croissance." }, availability: "Ouvert à de nouveaux projets clients", kicker: "Lancer un projet / Sans vente forcée", heading: ["Dites-nous ce que vous", "voulez rendre réel."], intro: "Apportez l’idée, le produit à moitié construit ou le problème que personne n’a encore démêlé. Le premier échange servira à trouver le signal et décider si nous devons construire ensemble.", book: "Réserver un appel projet", email: "Envoyer le brief", pathsKicker: "Choisissez un point de départ", pathsHeading: "Quel mouvement devons-nous créer ?", explore: "Explorer l’adéquation",
