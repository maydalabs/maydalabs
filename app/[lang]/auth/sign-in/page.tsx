...
const COPY = {
  en: {
    meta: {
      ...
      description: "Sign in to MaydaLabs with a six-digit email code. No password.",
    },
    kicker: "Account / Email code",
    heading: "Sign in without a password.",
    intro:
      "Enter your email and we send a six-digit code. New here? The same flow creates your account — it's used only for your saved Multiplier Maps, briefs, and preferences.",
    form: {
      emailLabel: "Email",
  ...
  tr: {
    meta: {
      ...
      description: "MaydaLabs'e altı haneli e-posta koduyla giriş yapın. Parola yok.",
    },
    kicker: "Hesap / E-posta kodu",
    heading: "Parolasız giriş yapın.",
    intro:
      "E-postanızı girin, altı haneli bir kod gönderelim. İlk kez mi? Aynı akış hesabınızı oluşturur — yalnızca kayıtlı Multiplier Map'leriniz, brief'leriniz ve tercihleriniz için kullanılır.",
    form: {
      emailLabel: "E-posta",
  ...
  fr: {
    meta: {
      ...
      description: "Connectez-vous à MaydaLabs avec un code e-mail à six chiffres. Sans mot de passe.",
    },
    kicker: "Compte / Code e-mail",
    heading: "Connectez-vous sans mot de passe.",
    intro:
      "Entrez votre e-mail et nous envoyons un code à six chiffres. Première visite ? Le même flux crée votre compte — utilisé uniquement pour vos Multiplier Maps, briefs et préférences.",
    form: {
      emailLabel: "E-mail",
