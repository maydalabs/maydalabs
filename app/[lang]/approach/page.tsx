...
const COPY = {
  en: {
    ...
    payNote: "Pay in bitcoin. Invoices are on-chain, priced in dollars at a rate locked when the invoice is written, and settled straight to our wallet with no processor in between. Bank transfer also works.",
  ...
  tr: {
    ...
    payNote: "Bitcoin ile ödeyin. Faturalar zincir üstüdür; dolar üzerinden, fatura yazılırken sabitlenen kurla fiyatlanır ve araya bir ödeme kuruluşu girmeden doğrudan cüzdanımıza ulaşır. Havale de mümkün.",
  ...
  fr: {
    ...
    payNote: "Payez en bitcoin. Les factures sont on-chain, libellées en dollars au taux bloqué au moment de leur émission, et réglées directement vers notre portefeuille, sans intermédiaire. Le virement reste possible.",
